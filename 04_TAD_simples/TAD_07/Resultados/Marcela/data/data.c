...
int CalculaDiferencaDias(tData data1, tData data2){ 
    int ordem=0, qtdDias=0, i, difDias=0, mesOriginal = 0;
    tData data1Aux, data2Aux;
    ...
    //Caso a 1 data seja menor
        ...
        for(i = data1.ano; i < data2.ano; i++){
            data1Aux.ano = i;
            data1Aux.mes = 12;
            qtdDias += CalculaDiasAteMes(data1Aux);
        }

        for(i = data1.mes; i < data2.mes; i++){
            data2Aux.mes = i;
            qtdDias += NumeroDiasMes(data2Aux);
        }
    ...
    //Caso a 2 data seja maior
        ...
        for(i = data2.ano; i < data1.ano; i++){
            data2Aux.ano = i;
            data2Aux.mes = 12;
            qtdDias += CalculaDiasAteMes(data2Aux);
        }
        for(i = data2.mes; i < data1.mes; i++){
            data1Aux.mes = i;
            qtdDias += NumeroDiasMes(data1Aux);
        } 
